<?php
Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/forcedefrappe.css');
Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/css/printRapport.css','print');
...
Yii::app()->clientScript->registerScript('frDatepicker.js', "
					...
					$('#btnRechercher').live('click',function(){
							...
							CHtml::ajax(array(
								'type'=>'GET',
								'url'=>array('rapportComplet'),
								'data'=>array('dateDebut'=>'js:dateDebut','dateFin'=>'js:dateFin', 'quarts'=>'js:quarts', 'equipes'=>'js:equipes', 'regroupement'=> 'js:regroup'
								),
...
echo CHtml::beginForm('','post',array('id'=>'formRapportComplet')); ?>
<div class="form">
	<div class="row span-12">
		<div  class="row span-4">
		<?php echo CHtml::label('Date de début :','dateDebut');
			echo CHtml::label('Min. : '.$parametres->maxDateReculRapport,'');
		...
		<?php 
			...
			echo CHtml::checkBoxList('Quarts', $ChkSelectedQ, $tblQuarts,array('labelOptions'=>array('style'=>'display:inline;')));
		?>
		</div>
		<div  class="row span-4">
		<?php 
			echo CHtml::label('Equipe :','');
			echo CHtml::checkBoxList('Equipes', $ChkSelectedE, $tblEquipes,array('labelOptions'=>array('style'=>'display:inline;')));
		?>
		</div>
		<div  class="row span-4">
		<?php 
			echo CHtml::label('Regroupement :','');
			echo CHtml::radioButtonList('Regroupement', $ChkSelectedR, $tblRegroup, array('labelOptions'=>array('style'=>'display:inline;')));
		?>
		</div>
	</div>
