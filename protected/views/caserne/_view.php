<div class="view span-7" style="margin:10px">
	...
	<?php echo CHtml::encode($data->numero).' '.CHtml::encode($data->adresse); ?>	
	<br/>
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('codePostal')); ?>:</b>
	<?php echo CHtml::encode($data->codePostal); ?>
	<br /><br />
