...
class QuartController extends Controller
{
	...
	public $pageTitle = "Quarts de travail";
	...
	{
		$dataProvider=new CActiveDataProvider('Quart', array(				
		));
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='quart-form')
		{
